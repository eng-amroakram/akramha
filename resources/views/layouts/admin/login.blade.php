...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="d-flex justify-content-center align-items-center col-sm-6">
                    <div class="card-body p-md-5 mx-md-4">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/admin/images/akramha-logo-text.png') }}" style="width: 210px;"
                                alt="logo">
                ...
                <div class="col-sm-6 px-0 d-none d-sm-block">
                    <img src="{{ asset('assets/admin/images/login-background.jpg') }}" alt="Login image" class="w-100 vh-100"
    ...
    <script type="text/javascript" src="{{ asset('assets/mdb/pro/js/core.min.js') }}"></script>
